    ...
    while True:
        ...
        if 功能开关["攻击舰队"] == 1:
            for h in range(3):
                ...
                re, _ = TomatoOcrText(
                    537, 320, 737, 360, "是否前往", match_mode="fuzzy"
                )
                if re:
                    Toast("取消前往星系")
                ...
                if 功能开关["仅寻找当前位置"] == 0:
                    re = TomatoOcrTap(
                        1013, 648, 1063, 680, "星系", sleep1=6, offsetX=5, offsetY=5
                    )
                    if not re:
                    ...
                    if not re:
                        ...
                        if re:
                            Toast("关闭任务页面")
                        re, _ = TomatoOcrText(
                            0, 600, 160, 690, "建造", match_mode="fuzzy"
                        )
                        if re:
                            Toast("取消左侧建造")
                            tapSleep(1240, 325, 1.5)
                        ...
                        if not re:
                            re = TomatoOcrFindRangeClick(
                                "星", x1=915, y1=595, x2=1249, y2=698
                            )
                        continue
                    ...
                    if 功能开关["采集残骸"] == 1:
                        for b in range(2):
                            ...
                            if 当前残骸目标:
                                ...
                                for m in range(3):
                                    ifFind = TomatoOcrTap(
                                        906, 379, 964, 410, "采集", offsetX=5, offsetY=5
                                    )
                ...
                if 功能开关["快速维修"] == 1:
                    ...
                    if re:
                        ...
                        if re:
                            re = TomatoOcrFindRangeClick(
                                "悬停召回", x1=792, y1=85, x2=1094, y2=145
                            )
                            if re:
                                Toast("悬停召回")
                            for k in range(30):
                                re, _, _ = TomatoOcrFindRange(
                                    "加速", x1=957, y1=142, x2=1085, y2=462
                                )
                                if not re:
                                    Toast("已召回")
                                    break
                            ...
                            if 功能开关["快速维修"] == 1:
                                re = TomatoOcrFindRangeClick(
                                    "快速维修", x1=959, y1=79, x2=1082, y2=274
                                )
                                if re:
                                    Toast("快速维修")
